...
<div class="page-flex">
    ...
    <div class="sidebar-start">
        <div class="sidebar-head">
            <a href="index.jsp" class="logo-wrapper" title="Home" target="_blank">
                ...
                <div class="logo-text">
                    <span class="logo-title">웹 서버</span>
        ...
        <div class="sidebar-body">
            <ul class="sidebar-body-menu">
                <li>
                    <a class="active" href="mypage.do"><span class="icon home" aria-hidden="true"></span>관리자 메인페이지</a>
                    <a class="active" href="getCustomerList.do"><span class="icon document" aria-hidden="true"></span>회원 정보 관리</a>
                </li>
        </div>
    </div>
  ...
  <div class="container main-nav">   
    ...
    <main class="main users chart-page" id="skip-target">
      <div class="container">
        <h2 class="main-title">웹 관리자 페이지</h2>
